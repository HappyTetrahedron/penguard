...
\begin{description}
    ...
    \item [Guardians] monitor the penguins using the Penguard app in guardian mode. The term ``guardian'' usually refers to the Penguard Guardian service or the user using the Penguard Android application
