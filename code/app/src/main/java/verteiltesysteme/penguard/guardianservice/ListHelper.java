...
final class ListHelper {
     ...
     */
    static void copyPenguinListFromProtobufList(PenguinList penguinList, List<PenguardProto.PGPPenguin> protobufList, Context context) {
        ...
        for (PenguardProto.PGPPenguin proto : protobufList) {
            if (getPenguinByAddress(penguinList, proto.getMac()) == null) { //No corresponding penguin in penguinList
                penguinList.add(new Penguin(proto.getMac(), proto.getName(), context));
            }
        }
    }
